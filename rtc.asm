...
;The start_i2c label indicates the start of the I2C start sequence. 
;The sequence starts with the SDA (serial data) line going LOW while the SCL (serial clock) line is HIGH. 
;This is accomplished by calling the sdaset and sclset subroutines. 
;The sdaset subroutine sets the SDA line HIGH, while the sclset subroutine sets the SCL line HIGH. 
;Next, the code calls the sdaclr and sclclr subroutines. 
...
;Next, the code sets or clears the SCL or SDA bit in the A register, 
;depending on which subroutine is being executed. 
